...
from flare.blocking import SMOKE_BLOCKING_THRESHOLD, _CROSS_STRUCT, compute_blocking_mask
...
from flare.dynamics.interaction_engine import InteractionEngine
from flare.dynamics.restriction_zones import RestrictionZoneModel
from flare.dynamics.traffic import TrafficModel
from flare.dynamics.pathfinding import bfs_shortest_path
from flare.envs.base import RejectReason, TerminationReason
from flare.missions.engine import MissionEngine
...
class UrbanEnvV2(gym.Env):
    ...
    def _load_osm_tile(
        ...
        """
        tile_path = (
            Path(__file__).resolve().parents[3]  # src/flare/envs → repo root
