...
risk cost functions, wind-driven fire, structural collapse, and triage missions.
...
5. **Backward compat**: wind_speed=0 → bit-identical to v2.
...
- **Structural collapse**: fire-triggered building collapse spawning permanent debris
...
- Unit tests for pure functions (fire CA, BFS, metrics, wind, collapse, triage)
