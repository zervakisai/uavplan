...
\title{Ranking Inversion in Risk-Parameterised UAV Path Planning\\
...
\begin{figure*}[h]
  \centering
  \includegraphics[width=\textwidth]{figures/wind_driven_fire.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figures/collapse_cascade.pdf}
...
\begin{figure*}[h]
  \centering
  \includegraphics[width=\textwidth]{figures/traffic_dynamics.pdf}
...
\begin{figure*}[h]
  \centering
  \includegraphics[width=\textwidth]{figures/risk_perception_5panel.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figures/mission_score_decomposition.pdf}
