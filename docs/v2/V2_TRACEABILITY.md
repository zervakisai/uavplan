...
| Req ID | Requirement Summary | Source Module(s) | Test File(s) | Evidence |
|--------|-------------------|------------------|-------------|----------|
| RU-1 | Single runner at benchmark/runner.py | `benchmark/runner.py` | `integration_test_runner_e2e.py` | `grep -c runner src/uavbench2/benchmark/` |
| RU-2 | Single CLI at cli/benchmark.py | `cli/benchmark.py` | `integration_test_cli.py` | `python -m uavbench2 --help` |
...
| RU-5 | CLI accepts --scenarios, --planners, etc. | `cli/benchmark.py` | `integration_test_cli.py` | `python -m uavbench2 run --help` |
