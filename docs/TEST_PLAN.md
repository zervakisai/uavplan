...
| `integration_test_cli.py` | CLI entry point | `python -m uavbench run --scenarios gov_civil_protection_easy --planners astar --trials 1 --seed-base 42 --output-dir /tmp/v2_test` exits 0 and produces JSON output |
