...
Generates:
  - outputs/v2/determinism_hashes.json  (DC-2 verification)
  - outputs/v2/viz_manifest.csv         (VC rendering manifest)
  - outputs/v2/viz_frame_checks.json    (VC per-frame validation)
  - outputs/v2/repro_manifest.json      (reproducibility manifest)
...
from uavbench2.scenarios.registry import list_scenarios  # noqa: E402
from uavbench2.planners import PLANNERS  # noqa: E402
from uavbench2.visualization.renderer import Renderer  # noqa: E402
from uavbench2.scenarios.loader import load_scenario  # noqa: E402
...
def export_repro_manifest() -> None:
    ...
    manifest = {
        ...
        "artifacts": [
            ...
            "outputs/v2/viz_manifest.csv",
            "outputs/v2/viz_frame_checks.json",
            "outputs/v2/repro_manifest.json",
            "outputs/v2/rebuild_audit.json",
        ],
        "contracts": [
