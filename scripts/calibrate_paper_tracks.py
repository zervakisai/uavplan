...
def _apply_adjustments(
    ...
    for sid in dynamic_scenarios:
        ...
        ad_sr = adaptive[(sid, "periodic_replan")]
        if base_sr > 0.05:
...
def main() -> None:
    ...
    for it in range(1, args.max_iters + 1):
        ...
        adaptive = _evaluate(dynamic_scenarios, ["periodic_replan"], seeds)
        ...
        dyn_ad = [adaptive[(sid, "periodic_replan")] for sid in dynamic_scenarios]
